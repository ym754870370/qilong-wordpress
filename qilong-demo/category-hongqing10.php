	...
	<div class="catePage">
		...
		<div class="cateContainer">
			<div class="cateSaide">
				...
				<div class="sideList">
					<a href="<?php bloginfo('url'); ?>/?cat=27">芽茶系列</a>
					<a href="<?php bloginfo('url'); ?>/?cat=28">7号烘青系列</a>
					<a href="<?php bloginfo('url'); ?>/?cat=29">8号烘青系列</a>
					<a href="<?php bloginfo('url'); ?>/?cat=30">9号烘青系列</a>
					<a href="<?php bloginfo('url'); ?>/?cat=32">白茶系列</a>
					<a href="<?php bloginfo('url'); ?>/?cat=31">生活茶系列</a>
				</div>
			</div>
