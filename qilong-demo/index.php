				  ...
				  <div class="product-wrap">
				    ...
				    <div class="product show">
				      <ul class="cf">
				        ...
				        <?php query_posts('cat=27&showposts=4&paged='.$page_num); ?> 
					        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				    ...
				    <div class="product">
				      <ul class="cf">
				      <?php query_posts('cat=28&showposts=4&paged='.$page_num); ?> 
					        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							    <li class="ml0"> <a href="<?php the_permalink(); ?>" class="imgwrap"> <img src="<?php echo catch_that_image() ?>"> </a>
				          <p class="mt10"> <a href="#"><?php the_title(); ?> </a></p>
				        </li>
				    ...
				    <div class="product">
				      <ul class="cf">
				      <?php query_posts('cat=29&showposts=4&paged='.$page_num); ?> 
					        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							    <li class="ml0"> <a href="<?php the_permalink(); ?>" class="imgwrap"> <img src="<?php echo catch_that_image() ?>"> </a>
				          <p class="mt10"> <a href="#"><?php the_title(); ?> </a></p>
				        </li>
				    ...
				    <div class="product">
				      <ul class="cf">
				      <?php query_posts('cat=30&showposts=4&paged='.$page_num); ?> 
					        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							    <li class="ml0"> <a href="<?php the_permalink(); ?>" class="imgwrap"> <img src="<?php echo catch_that_image() ?>"> </a>
				          <p class="mt10"> <a href="#"><?php the_title(); ?> </a></p>
				        </li>
				    ...
				    <div class="product">
				      <ul class="cf">
				      <?php query_posts('cat=32&showposts=4&paged='.$page_num); ?> 
					        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							    <li class="ml0"> <a href="<?php the_permalink(); ?>" class="imgwrap"> <img src="<?php echo catch_that_image() ?>"> </a>
				          <p class="mt10"> <a href="#"><?php the_title(); ?> </a></p>
				        </li>
				    ...
				    <div class="product">
				      <ul class="cf">
				      <?php query_posts('cat=31&showposts=4&paged='.$page_num); ?> 
					        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							    <li class="ml0"> <a href="<?php the_permalink(); ?>" class="imgwrap"> <img src="<?php echo catch_that_image() ?>"> </a>
				          <p class="mt10"> <a href="#"><?php the_title(); ?> </a></p>
				        </li>
				    ...
				    <div class="product">
				      <ul class="cf">
				      <?php query_posts('cat=33&showposts=4&paged='.$page_num); ?> 
					        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							    <li class="ml0"> <a href="<?php the_permalink(); ?>" class="imgwrap"> <img src="<?php echo catch_that_image() ?>"> </a>
				          <p class="mt10"> <a href="#"><?php the_title(); ?> </a></p>
				        </li>
		...
		<div class="teaAbout">
			<div class="teawenhua">
				...
				<div class="teaAboutContent">
					<h3><a href="<?php bloginfo('url'); ?>/?cat=22">中国茶文化</a></h3>
					<hr>
					<p>了解中华茶文化，传承茶道精髓。</p>
				</div>
			</div>
			<div class="teaxiangqing">
				<div class="teaAboutPic"></div>
				<div class="teaAboutContent">
					<h3><a href="<?php bloginfo('url'); ?>/?page_id=98">公司详情</a></h3>
					<hr>
					<p>了解中华茶文化，传承茶道精髓。</p>
				</div>
			</div>
			...
			<div class="teazeren">
				<div class="teaAboutContent">
					<h3><a href="<?php bloginfo('url'); ?>/?cat=21">社会责任</a></h3>
					<hr>
					<p>了解中华茶文化，传承茶道精髓。</p>
				</div>
				<div class="teaAboutPic"></div>
			...
			<div class="teashishi">
				<div class="teaAboutPic"></div>
				<div class="teaAboutContent">
					<h3><a href="<?php bloginfo('url'); ?>/?page_id=109">实时监控视频</a></h3>
					<hr>
					<p>了解中华茶文化，传承茶道精髓。</p>
				</div>
			</div>
